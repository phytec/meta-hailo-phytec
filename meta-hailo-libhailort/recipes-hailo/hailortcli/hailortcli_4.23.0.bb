DESCRIPTION = "hailortcli - command line utility wrapper for libhailort operations on Hailo-8/8L/8R \
               (fw controls, measurements, inference and more). Kept as hailortcli (not \
               hailort8cli) so it matches existing Hailo-8 documentation and scripts - the \
               Hailo-10/15 build is the one renamed to hailort10cli instead \
               (hailort10cli_5.3.0.bb)."
